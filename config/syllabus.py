"""
syllabus.py — The AI² Career Roadmap syllabus data.

This is the single source of truth for the 13-week curriculum.
...
def get_progress(syllabus_progress: dict, selected_roles: list[str]) -> dict:
    ...
    for phase in PHASES:
        ...
        for ti, track in enumerate(phase["tracks"]):
            # Skip tracks not relevant to selected roles
